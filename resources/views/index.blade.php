...
<head>
    ...
    <title>Sanca Restaurant &mdash; Food Specialty </title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="main-wrapper">
                  ...
                  <div class="carousel-inner">
                    <div class="container">
                      <div class="carousel-caption fadeInUp animated" style="bottom:0;top:200px">
                        <h2 class="display-1" style="color:#fff;">Sanca Restaurant</h2>
        ...
        <div id="about">
            <div class="row" style="background-image:url({{ asset('resto/images/wood_1.png')}});">
              ...
              <div class="col-md-6" style="padding:30px 50px;">
                ...
                <p class="lead" style="color:#a99c92;font-weight: 300">Sanca Restaurant, Restoran dengan gaya khas Western yang sangat cocok untuk berbagai acara dan kebutuhan. Dikenal sejak tahun 1867, Kami menggunakan bahan - bahan yang berkualitas dan dipilah secara baik dari sumbernya sehingga menghasilkan hasil masakan yang lezat dan berkualitas. Sanca Restaurant menyediakan tempat untuk anda yang ingin berbagi momen bersama orang - orang disekitar anda melalui makanan yang kami sediakan, mari pesan tempat anda sekarang.</p>
              </div>
            </div>
        </div>
                    ...
                    <div class="carousel-item active" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          <h3 class="display-4" style="color:#5e493a;font-size: 40px ;">"Makan adalah hobiku. Sanca Restaurant mengirim hobiku ke tingkatan selanjutnya."</h3>
                ...
                <div class="col-md-6">
                    ...
                    <ul>
                        <li style="padding-left: 50px;margin-bottom: 10px">
                            ...
                            Tembalang no. 187, <br> Semarang, Jawa Tengah
                        </li>
                        <li style="padding-left: 50px;margin-bottom: 10px"><i class="icon-phone" style="position: absolute;left: 20px"></i> (0361)237-163</li>
                        <li style="padding-left: 50px;margin-bottom: 10px"><i class="icon-envelope" style="position: absolute;left: 20px"></i>sanca@gmail.com</li>
                        <li style="padding-left: 50px;margin-bottom: 10px"><i class="icon-globe" style="position: absolute;left: 20px"></i> <a href="#" target="_blank">sanca.com</a></li>
                    </ul>
                </div>
                <div class="col-md-6">
        ...
        <div id="team" class="col-md-12" style="background-image:url({{ asset('resto/images/slide_3.jpg')}});background-size: cover;padding-bottom: 50px">
            <div class="container">
                <h2 class="display-4" style="text-align:center;color:#fff;padding:50px 0;"> 8 - Team</h2>
                <div class="row justify-content-center" style="padding: 15px">
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/sandy.jpg')}}" title="Jhona" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/caca.jpeg')}}" title="Ilham" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                </div>
            </div>
        </div>
